...
public class MproDetDAO {
    ...
    public static boolean saveMproDetTransList(DataSource ds, List<MproDetVO> listMproDet) {
    ...
    public static boolean saveMproDetSwitchList(DataSource ds, List<MproDetVO> listMproDet) {
